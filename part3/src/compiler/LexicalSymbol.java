 ...
 *
 * @author Not fully determined but assumed to be among Marie Van Den Bogaard, Léo Exibard, Gilles Geeraerts.
...
public class LexicalSymbol {
	...
	/**
	 * Creates a LexicalSymbol using the provided attributes.
	 *
	 ...
	 */
	public LexicalSymbol(LexicalUnit unit, int line, int column, Object value) {
		this.type = unit;
		this.line = line + 1;
		this.column = column;
		this.value = value;
	...
	/**
	 * Creates a LexicalSymbol using the provided attributes and no value.
	 *
	 * @param unit   the LexicalUnit (terminal) associated with the symbol.
	 * @param line   the line where the symbol appears in the file.
	 * @param column the column where the symbol appears in the file.
	 */
	public LexicalSymbol(LexicalUnit unit, int line, int column) {
		this(unit, line, column, NO_VALUE);
	}

	/**
	 * Creates a LexicalSymbol using the provided attributes, without column nor value.
	 *
	 * @param unit the LexicalUnit (terminal) associated with the symbol.
	 * @param line the line where the symbol appears in the file.
	 */
	public LexicalSymbol(LexicalUnit unit, int line) {
		this(unit, line, UNDEFINED_POSITION, NO_VALUE);
	}

	/**
	 * Creates a LexicalSymbol using the provided attributes, without position or value.
	 *
	 * @param unit the LexicalUnit (terminal) associated with the symbol.
	 */
	public LexicalSymbol(LexicalUnit unit) {
		this(unit, UNDEFINED_POSITION, UNDEFINED_POSITION, NO_VALUE);
	}

	/**
	 * Creates a LexicalSymbol using the provided attributes, without position.
	 *
	 * @param unit  the LexicalUnit (terminal) associated with the symbol.
	 * @param value the value of the symbol.
	 */
	public LexicalSymbol(LexicalUnit unit, Object value) {
	 ...
	 *
	 * @return a boolean which is true iff the LexicalSymbol represents a terminal.
	 */
	 ...
	 *
	 * @return a hash code based on the type and value of the LexicalSymbol.
	 */
	@Override
	public int hashCode() {
