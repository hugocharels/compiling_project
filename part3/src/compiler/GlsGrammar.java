...
public class GlsGrammar {
	...
	private void buildProductionRules() {
		...
		this.productionRules.add(new ProductionRule(7, GlsVariable.INSTRUCTION, List.of(GlsVariable.FOR)));
		this.productionRules.add(new ProductionRule(8, GlsVariable.INSTRUCTION, List.of(GlsVariable.OUTPUT)));
		this.productionRules.add(new ProductionRule(9, GlsVariable.INSTRUCTION, List.of(GlsVariable.INPUT)));
		this.productionRules.add(new ProductionRule(10, GlsVariable.ASSIGN, List.of(GlsTerminal.VARNAME, GlsTerminal.ASSIGN, GlsVariable.EXPR_ARITH)));
		this.productionRules.add(new ProductionRule(11, GlsVariable.EXPR_ARITH, List.of(GlsVariable.PROD_ARITH, GlsVariable.EXPR_ARITH_PRIME)));
		this.productionRules.add(new ProductionRule(12, GlsVariable.EXPR_ARITH_PRIME, List.of(GlsTerminal.PLUS, GlsVariable.PROD_ARITH, GlsVariable.EXPR_ARITH_PRIME)));
		this.productionRules.add(new ProductionRule(13, GlsVariable.EXPR_ARITH_PRIME, List.of(GlsTerminal.MINUS, GlsVariable.PROD_ARITH, GlsVariable.EXPR_ARITH_PRIME)));
		this.productionRules.add(new ProductionRule(14, GlsVariable.EXPR_ARITH_PRIME, List.of(GlsTerminal.EPSILON)));
		this.productionRules.add(new ProductionRule(15, GlsVariable.PROD_ARITH, List.of(GlsVariable.ATOM, GlsVariable.PROD_ARITH_PRIME)));
		this.productionRules.add(new ProductionRule(16, GlsVariable.PROD_ARITH_PRIME, List.of(GlsTerminal.TIMES, GlsVariable.ATOM, GlsVariable.PROD_ARITH_PRIME)));
		this.productionRules.add(new ProductionRule(17, GlsVariable.PROD_ARITH_PRIME, List.of(GlsTerminal.DIVIDE, GlsVariable.ATOM, GlsVariable.PROD_ARITH_PRIME)));
		this.productionRules.add(new ProductionRule(18, GlsVariable.PROD_ARITH_PRIME, List.of(GlsTerminal.EPSILON)));
		this.productionRules.add(new ProductionRule(19, GlsVariable.ATOM, List.of(GlsTerminal.NUMBER)));
		this.productionRules.add(new ProductionRule(20, GlsVariable.ATOM, List.of(GlsTerminal.VARNAME)));
		this.productionRules.add(new ProductionRule(21, GlsVariable.ATOM, List.of(GlsTerminal.LPAREN, GlsVariable.EXPR_ARITH, GlsTerminal.RPAREN)));
		this.productionRules.add(new ProductionRule(22, GlsVariable.ATOM, List.of(GlsTerminal.MINUS, GlsVariable.ATOM)));
		this.productionRules.add(new ProductionRule(23, GlsVariable.IF, List.of(GlsTerminal.IF, GlsTerminal.LBRACK, GlsVariable.COND, GlsTerminal.RBRACK, GlsTerminal.THEN, GlsVariable.CODE, GlsVariable.IFSEQ)));
		this.productionRules.add(new ProductionRule(24, GlsVariable.IFSEQ, List.of(GlsTerminal.END)));
		this.productionRules.add(new ProductionRule(25, GlsVariable.IFSEQ, List.of(GlsTerminal.ELSE, GlsVariable.CODE, GlsTerminal.END)));
		this.productionRules.add(new ProductionRule(26, GlsVariable.COND, List.of(GlsVariable.COND_SIMPLE, GlsVariable.NEXT_COND)));
		this.productionRules.add(new ProductionRule(27, GlsVariable.NEXT_COND, List.of(GlsTerminal.IMPLIES, GlsVariable.COND_SIMPLE, GlsVariable.NEXT_COND)));
		this.productionRules.add(new ProductionRule(28, GlsVariable.NEXT_COND, List.of(GlsTerminal.EPSILON)));
		this.productionRules.add(new ProductionRule(29, GlsVariable.COND_SIMPLE, List.of(GlsTerminal.PIPE, GlsVariable.COND, GlsTerminal.PIPE)));
		this.productionRules.add(new ProductionRule(30, GlsVariable.COND_SIMPLE, List.of(GlsVariable.EXPR_ARITH, GlsVariable.COMP, GlsVariable.EXPR_ARITH)));
		this.productionRules.add(new ProductionRule(31, GlsVariable.COMP, List.of(GlsTerminal.EQUAL)));
